...
@register_model
def convnext_tiny(num_classes: int, pretrained=False,in_22k=False, **kwargs):
...
@register_model
def convnext_small(num_classes: int, pretrained=False,in_22k=False, **kwargs):
...
@register_model
def convnext_base(num_classes: int, pretrained=False, in_22k=False, **kwargs):
...
@register_model
def convnext_large(num_classes: int, pretrained=False, in_22k=False, **kwargs):
...
@register_model
def convnext_xlarge(num_classes: int, pretrained=False, in_22k=False, **kwargs):
