...
def MobileNet_v3_S(num_classes: int,**kwargs):
    """
    Constructs a MobileNet V3-Small model
    """
    return MobileNetV3_Small(num_classes = num_classes, **kwargs)

def MobileNet_v3_L(num_classes: int,**kwargs):
    """
    Constructs a MobileNet V2 model
    """
    return MobileNetV3_Large(num_classes = num_classes, **kwargs)