...
def ResNet_18(num_classes: int, **kwargs: Any) -> ResNet:
    model = ResNet([2, 2, 2, 2], _BasicBlock, num_classes = num_classes, **kwargs)
    return model


def ResNet_34(num_classes: int, **kwargs: Any) -> ResNet:
    model = ResNet([3, 4, 6, 3], _BasicBlock, num_classes = num_classes, **kwargs)
    return model


def ResNet_50(num_classes: int, **kwargs: Any) -> ResNet:
    model = ResNet([3, 4, 6, 3], _Bottleneck, num_classes = num_classes, **kwargs)
    return model


def ResNet_101(num_classes: int, **kwargs: Any) -> ResNet:
    model = ResNet([3, 4, 23, 3], _Bottleneck, num_classes = num_classes, **kwargs)
    return model


def ResNet_152(num_classes: int, **kwargs: Any) -> ResNet:
    model = ResNet([3, 8, 36, 3], _Bottleneck, num_classes = num_classes, **kwargs)
    return model